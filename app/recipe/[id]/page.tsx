...
const RecipePageContent = memo(() => {
  ...
  return (
    ...
    >
      ...
      {/* Main Content Area */}
      <div className="flex-1 ml-[15%] sm:ml-64 min-h-screen">
        {/* Header with Back Button - Transparent to show image through */}
        <div className="sticky top-0 z-40 bg-slate-900/50 backdrop-blur-sm border-b border-green-500/30">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="rounded-xl border border-white/10 bg-gradient-to-r from-rose-500/70 via-rose-500/50 to-rose-500/30 backdrop-blur-sm shadow-[0_15px_35px_rgba(225,29,72,0.45)] transition duration-200 hover:border-rose-300/40 hover:from-rose-500/80 hover:via-rose-500/60 hover:to-rose-500/40 text-white"
                  aria-label={
                ...
                {isAuthenticated && (
                  <Button
                    ...
                    className="rounded-xl border border-white/10 bg-gradient-to-r from-green-500/70 via-green-500/50 to-green-500/30 backdrop-blur-sm shadow-[0_15px_35px_rgba(34,197,94,0.45)] transition duration-200 hover:border-green-300/40 hover:from-green-500/80 hover:via-green-500/60 hover:to-green-500/40 text-white"
        ...
        <div className="px-2 sm:px-4 py-4 sm:py-6">
          {isLoading ? (
            ...
            >
              ...
              {/* Content Section - Conditional rendering based on activeTab */}
              <Card className="group rounded-[28px] border border-slate-400/30 bg-gradient-to-br from-slate-500/25 via-slate-500/10 to-slate-500/5 backdrop-blur-sm shadow-[0_30px_80px_rgba(71,85,105,0.35)] transition hover:border-slate-300/50">
                  ...
                  <div className="w-full">
                    ...
                    {activeTab === "summary" && (
                      <div className="space-y-6 mt-0 transition-opacity duration-300">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                          ...
                          {(() => {
                            ...
                            return caloriesValue ? (
                              <Card className="group rounded-[28px] border border-purple-400/30 bg-gradient-to-br from-purple-500/25 via-purple-500/10 to-purple-500/5 p-6 shadow-[0_30px_80px_rgba(168,85,247,0.35)] transition hover:border-purple-300/50 backdrop-blur-sm">
                        ...
                        {sourceUrl && (
                          <Card className="rounded-[28px] border border-emerald-400/30 bg-gradient-to-br from-emerald-500/25 via-emerald-500/10 to-emerald-500/5 p-6 mt-6 shadow-[0_30px_80px_rgba(16,185,129,0.35)] transition hover:border-emerald-300/50">
                    ...
                    {activeTab === "info" && (
                      <div className="space-y-6 mt-0 transition-opacity duration-300">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                  ...
                                  {recipeInfo?.glutenFree && (
                                    <div className="flex items-center gap-2">
                                      ...
                                      <Badge className="bg-amber-500/20 backdrop-blur-sm text-amber-300 border-amber-500/30">
                                        Gluten Free
                                      </Badge>
                                    </div>
                                  )}
                                  {recipeInfo?.dairyFree && (
                                    <div className="flex items-center gap-2">
                                      ...
                                      <Badge className="bg-blue-500/20 backdrop-blur-sm text-blue-300 border-blue-500/30">
                                        Dairy Free
                                      </Badge>
                                    </div>
                                  )}
                                  {recipeInfo?.ketogenic && (
                                    <div className="flex items-center gap-2">
                                      ...
                                      <Badge className="bg-orange-500/20 backdrop-blur-sm text-orange-300 border-orange-500/30">
                                        Ketogenic
                                      </Badge>
                                    </div>
                                  )}
                                  {recipeInfo?.whole30 && (
                                    <div className="flex items-center gap-2">
                                      ...
                                      <Badge className="bg-purple-500/20 backdrop-blur-sm text-purple-300 border-purple-500/30">
                                        Whole30
                                      </Badge>
                                    </div>
                                  )}
                                  {recipeInfo?.lowFodmap && (
                                    <div className="flex items-center gap-2">
                                      ...
                                      <Badge className="bg-indigo-500/20 backdrop-blur-sm text-indigo-300 border-indigo-500/30">
                                        Low FODMAP
                                      </Badge>
                                    </div>
                                  )}
                          ...
                          <Card className="group rounded-[28px] border border-indigo-400/30 bg-gradient-to-br from-indigo-500/25 via-indigo-500/10 to-indigo-500/5 p-6 shadow-[0_30px_80px_rgba(99,102,241,0.35)] transition hover:border-indigo-300/50 backdrop-blur-sm">
                            <div className="flex items-start gap-4">
                              <div className="p-3 bg-indigo-500/20 rounded-lg backdrop-blur-sm">
                                <ChefHat className="h-6 w-6 text-indigo-300" />
                              </div>
                              <div className="flex-1">
                                <h3 className="text-lg sm:text-xl font-semibold text-white mb-4">
                                  Cuisine & Dish Types
                                      ...
                                      <div className="flex flex-wrap gap-2">
                                        {recipeInfo.cuisines.map(
                                          (cuisine, idx) => (
                                            <Badge
                                              key={idx}
                                              className="bg-blue-500/20 backdrop-blur-sm text-blue-300 border-blue-500/30"
                                            >
                                              {cuisine}
                                            </Badge>
                                          )
                                      ...
                                      <div className="flex flex-wrap gap-2">
                                        {recipeInfo.dishTypes.map(
                                          (dishType, idx) => (
                                            <Badge
                                              key={idx}
                                              className="bg-indigo-500/20 backdrop-blur-sm text-indigo-300 border-indigo-500/30"
                                            >
                                              {dishType}
                                            </Badge>
                                          )
                        ...
                        {(recipeInfo?.cookingMinutes ||
                          ...
                          recipeInfo?.readyInMinutes) && (
                          <Card className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border-purple-500/30 p-4 sm:p-6 backdrop-blur-sm">
                            <div className="flex items-start gap-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          {recipeInfo?.sustainable !== undefined && (
                            <Card className="group rounded-[28px] border border-green-400/30 bg-gradient-to-br from-green-500/25 via-green-500/10 to-green-500/5 p-6 shadow-[0_30px_80px_rgba(34,197,94,0.35)] transition hover:border-green-300/50 backdrop-blur-sm">
                              <div className="flex items-start justify-between gap-4">
                                <div>
                                  <p className="text-xs uppercase tracking-[0.45em] text-white/60">
                                    Sustainable
                          ...
                          {recipeInfo?.weightWatcherSmartPoints && (
                            <Card className="group rounded-[28px] border border-blue-400/30 bg-gradient-to-br from-blue-500/25 via-blue-500/10 to-blue-500/5 p-6 shadow-[0_30px_80px_rgba(59,130,246,0.35)] transition hover:border-blue-300/50 backdrop-blur-sm">
                              <div className="flex items-start justify-between gap-4">
                                <div>
                                  <p className="text-xs uppercase tracking-[0.45em] text-white/60">
                          ...
                          {recipeInfo?.license && (
                            <Card className="group rounded-[28px] border border-slate-400/30 bg-gradient-to-br from-slate-500/25 via-slate-500/10 to-slate-500/5 p-6 shadow-[0_30px_80px_rgba(71,85,105,0.35)] transition hover:border-slate-300/50 backdrop-blur-sm">
                              <div className="flex items-start justify-between gap-4">
                                <div>
                                  <p className="text-xs uppercase tracking-[0.45em] text-white/60">
                                    License
                          ...
                          {recipeInfo?.occasions &&
                            recipeInfo.occasions.length > 0 && (
                              <Card className="rounded-[28px] border border-pink-400/30 bg-gradient-to-br from-pink-500/25 via-pink-500/10 to-pink-500/5 p-4 shadow-[0_20px_60px_rgba(236,72,153,0.3)] transition hover:border-pink-300/50">
                          ...
                          {recipeInfo?.gaps && (
                            <Card className="rounded-[28px] border border-emerald-400/30 bg-gradient-to-br from-emerald-500/25 via-emerald-500/10 to-emerald-500/5 p-4 shadow-[0_20px_60px_rgba(16,185,129,0.3)] transition hover:border-emerald-300/50">
                              <div className="flex items-center gap-3">
                      ...
                      <div className="space-y-6 mt-0 transition-opacity duration-300">
                                  ...
                                  <div className="space-y-3">
                                    {recipeInfo.extendedIngredients.map(
                                      (ingredient, idx) => (
                                        <div
                                          key={idx}
                                          className="flex items-start gap-3 p-3 bg-slate-800/50 backdrop-blur-sm rounded-lg border border-orange-500/20 hover:border-orange-500/40 transition-colors"
                                        >
                                          {/* Ingredient Image */}
                                          {ingredient.image && (
                        ...
                        ((recipeInfo?.analyzedInstructions &&
                          ...
                          <Card className="group rounded-[28px] border border-indigo-400/30 bg-gradient-to-br from-indigo-500/25 via-indigo-500/10 to-indigo-500/5 p-6 shadow-[0_30px_80px_rgba(99,102,241,0.35)] transition hover:border-indigo-300/50 backdrop-blur-sm">
                            <div className="flex items-start gap-4 mb-4">
                              <div className="p-3 bg-indigo-500/20 rounded-lg backdrop-blur-sm">
                                <List className="h-6 w-6 text-indigo-300" />
                              </div>
                              <div className="flex-1">
                                <h3 className="text-lg sm:text-xl font-semibold text-white mb-4">
                                  Instructions
                                        ...
                                        >
                                          ...
                                          {instruction.steps.map(
                                            (step, stepIdx) => (
                                              <div
                                                key={stepIdx}
                                                className="flex items-start gap-3 p-4 rounded-[20px] border border-sky-400/30 bg-gradient-to-br from-sky-500/20 via-sky-500/8 to-sky-500/3 shadow-[0_15px_40px_rgba(14,165,233,0.25)] hover:border-sky-300/50 transition-all"
                                              >

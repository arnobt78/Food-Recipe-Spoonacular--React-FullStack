...
const ConfirmationDialog = memo(({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="glow-card border-green-500/30 bg-slate-900">
        <DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            className={
              variant === "destructive"
                ? "bg-red-600 hover:bg-red-700 text-white shadow-lg shadow-red-500/50 hover:shadow-xl hover:shadow-red-500/70 transition-all duration-300"
                : "glow-button"
            }

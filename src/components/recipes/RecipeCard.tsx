        ...
        <Card className="glow-card group h-full flex flex-col overflow-hidden min-h-[320px]">
          ...
          <div className="relative overflow-hidden rounded-t-lg h-48">
            ...
            <div className="absolute top-2 left-2 z-10">
              ...
              >
                {showRemoveButton ? (
                  ...
                  <AiOutlineHeart
                    size={24}
                    className="text-white drop-shadow-lg group-hover:text-green-300 transition-colors"
                  />
                )}
              </Button>
            </div>
            ...
            <div className="absolute bottom-2 left-2 right-2 flex flex-wrap gap-2 z-10">
              ...
              {cardInfo && (
                <>
                  {cardInfo.time && recipe.readyInMinutes === undefined && (
                    <Badge className="bg-black/60 backdrop-blur-sm text-white border-green-400/30 text-xs px-2 py-1">
          ...
          <CardContent className="p-4 flex-1 flex flex-col min-h-[100px]">
            ...
            <div className="flex items-start justify-between gap-2 mb-2">
              <h3 className="text-lg font-semibold text-white w-full line-clamp-2 group-hover:text-green-200 transition-colors min-h-[3.5rem] flex items-start">
                {recipe.title}
              </h3>
              ...
              {recipe.likes !== undefined && recipe.likes > 0 && (
                <Badge
                  variant="outline"
                  className="bg-green-500/10 border-green-500/30 text-green-300 text-xs flex-shrink-0"
                >
                  <Star className="h-3 w-3 mr-1 fill-green-400" />
                  {recipe.likes}
                </Badge>
              )}
            </div>
